...
export const LogoBox = () => {
    useEffect(() => {
        ...
        var nodeBox = Bodies.rectangle(450, 250, 60, 60, {restitution:0.5});
        var jsBox = Bodies.rectangle(450, 250, 60, 60,{restitution:0.8});
        var typescriptBox = Bodies.rectangle(450, 250, 80, 80,{restitution:0.5});
        ...
        nodeBox.render.sprite.texture = "Assets/logo/node.svg";
        jsBox.render.sprite.texture = "Assets/logo/js.svg";
        typescriptBox.render.sprite.texture = "Assets/logo/typescript.svg";
        ...
        let allBox = [typescriptBox,photoshopBox,protoolsBox,phpBox,sqlBox, tailwindBox,jsBox,nextBox,reactBox,htmlBox,cBox,cssBox,terminalBox,nodeBox];
        ...
        Composite.add(engine.world, [...allBox, circleGround, ground,LeftBorder,RightBorder,topBorder]);
      ...
      return (
          ...
          <div className="cursor-pointer LogoBox w-fit h-fit left-[calc(48%-20px)] translate-x-[-50%] top-10 md:-top-10 absolute"></div>
